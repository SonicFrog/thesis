...
\subsection{UDP stack} \label{sec:udp-design}
...
R2P2, the choice was made to use it as an RPC protocol for our key value
store.
...
The R2P2 request is also responsible for the reliable delivery of
...
duplicating work it should also identify when a request has already
been processed by the user application and avoid processing this
request again.
...
not zero-copy. We thus implement all our networking stack on top of
DPDK.
