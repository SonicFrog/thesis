...
\subsubsection{DPDK} \todo{rephrase section according to Marios' suggestions}
...
\subsubsection{NetBricks} \todo{rephrase section}
...
\subsubsection{UDP stack} \todo{rephrase section}
...
\subsubsection{R2P2 server} \todo{rephrase section}
...
\todo{Throughput / latency graph}
\todo{Tail latency evaluation}
